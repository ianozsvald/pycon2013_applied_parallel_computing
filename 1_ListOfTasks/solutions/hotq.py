"""HotQueue Redis example, use --server flag to setup work and consume without the --server flag"""
import argparse
import datetime
import time
import hotqueue
...
if __name__ == "__main__":
    ...
    parser.add_argument('--server', action="store_true", help="", default=False)
    ...
    validation_sum = calc_pure_python(True, args)
